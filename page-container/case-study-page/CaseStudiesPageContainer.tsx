...
Our partner Vincent Lau, lead the development of reservation systems and IoT integrations of the award winning sleeping pod, during his time with Space is Ltd.`
  ...
  { title: 'HYPEFEST by Hypebeast', imgSrc: '/case_hypefest.jpg', content: 'Mobile App developed by ReactNative. For a 2 days event named HYPEFEST.' },
  {
    ...
    content: 'HK01 Project to let NGO submit their campaign and let HK01 members donate the projects'
  },
  {
  ...
  { title: 'OneSky', imgSrc: '/case_onesky.jpg', content: 'OneSky a SaaS translation service platform. Which providing translation service to big clients' },
  {
    title: 'Nestle campaign site By HK01',
    imgSrc: '/case_hk01_nestle.jpg',
    content: 'A mini-site to one-off campaign from nestle and HK01, simple web page to let users answer the questionnaire and lucky draw.'
  },
  {
    ...
    <>
      <Box mx="10%">
        <Grid container direction="column">
          ...
          <Box mt="9.63rem" color="text.secondary" fontSize="3.75rem" fontWeight={300}>
            Case Studies
          </Box>
